<?php 
@include 'config.php';
$sql = "SELECT order_id,`name`, `address`, `order`, `quantity` FROM user_form, order_tbl WHERE user_form.user_id = order_tbl.user_id AND `status` = 'pending' AND `order` != 'Refill';";
